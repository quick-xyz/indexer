...
log.attributes.get("owner")
log.attributes.get("amount")
log.attributes.get("amount0")
log.attributes.get("amount1")
...
log.attributes.get("sender")
log.attributes.get("recipient")
log.attributes.get("amount0")
log.attributes.get("amount1")
log.attributes.get("liquidity")
